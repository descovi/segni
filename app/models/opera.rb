class Opera < ActiveRecord::Base
  # d is for dynamic
  # c is for cropped
  has_attached_file :image_paper, styles: { 
    _20x20c:    '20x20#',
    _50x50c:    '50x50#',
    _100x100c:  '100x100#',
    _200x200c:  '200x200#',
  ...
  validates_attachment_content_type :image_paper, content_type: /\Aimage\/.*\Z/
  crop_attached_file :image_paper, :aspect => false
  ...
  # has_many :images, through: :images_opera
