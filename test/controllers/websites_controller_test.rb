...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { name-slug: @website.name-slug, name: @website.name, primary_color: @website.primary_color, secondary_color: @website.secondary_color }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { name-slug: @website.name-slug, name: @website.name, primary_color: @website.primary_color, secondary_color: @website.secondary_color }
    assert_redirected_to website_path(assigns(:website))
  end
